...
public class WeeklySales {
  public static void main(String[] args) {
    ...
    salesStaff[0] = new SalePerson("Jane", "Cherry", 3000);
    salesStaff[1] = new SalePerson("Daffy", "Duck", 4935);
    salesStaff[2] = new SalePerson("James", "Apple", 3000);
    salesStaff[3] = new SalePerson("Dick", "Lemon", 2800);
    salesStaff[4] = new SalePerson("Don", "Salt", 1570);
    salesStaff[5] = new SalePerson("Jane", "Banana", 3000);
    ...
    salesStaff[9] = new SalePerson("Walt", "Coconut", 3000);
